...
describe TimecopConsole::MainHelper, :type => :helper do
  describe "#time_travel_to" do
    context "when a Date object is passed" do
      ...
      it 'should return a button with timecop console route' do
        helper.time_travel_to(date).should == "<form class=\"button_to\" method=\"post\" action=\"/timecop_console/update?timecop%5Bcurrent_time%281i%29%5D=1950&amp;timecop%5Bcurrent_time%282i%29%5D=12&amp;timecop%5Bcurrent_time%283i%29%5D=12&amp;timecop%5Bcurrent_time%284i%29%5D=12&amp;timecop%5Bcurrent_time%285i%29%5D=0\"><input type=\"submit\" value=\"December 12, 1950\" /></form>"
      end
